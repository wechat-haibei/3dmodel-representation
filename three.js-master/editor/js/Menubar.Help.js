...
function MenubarHelp( editor ) {
	...
	option.onClick( function () {
		...
		window.open( 'https://github.com/wechat-haibei/3D-deeplearning-processing', '_blank' );
	...
	*/
	...
	option.onClick( function () {
		...
		window.open( 'https://www.bilibili.com/video/BV1Zg411w7ZB?spm_id_from=333.999.0.0', '_blank' );
